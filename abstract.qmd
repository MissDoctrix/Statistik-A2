...
Die vorliegende Studie verfolgte das Ziel, Anforderungen von NutzerInnen an eine KI-Anwendung zur Erkennung von Misinformationen auf Social Media zu identifizieren. Zu diesem Zweck wurde ein Mixed-Method-Ansatz gewählt, bestehend aus zwei qualitativen Interviews und einer quantitativen Online-Umfrage mit 176 Teilnehmenden. Diese Kombination erlaubte es, sowohl subjektive Einschätzungen und Wünsche als auch objektive Messdaten wie mentale Belastung und Vertrauen zu erheben. Besonders im Vordergrund stand dabei die Frage, wie die NutzerInnen die Gestaltung, Funktion und Wirkung einer solchen Anwendung erleben und welche Aspekte für sie besonders wichtig sind.
 qualitativen Ergebnisse machen deutlich, dass NutzerInnen hohe Erwartungen an die Gestaltung von KI-Systemen haben. Genannt wurden unter anderem Barrierefreiheit, einfache und schnelle Verständlichkeit, nachvollziehbare Quellenangaben, politische Neutralität sowie Unabhängigkeit von personenbezogenen Daten. Interessant war auch die Betonung der Beständigkeit der KI-Ergebnisse – viele wünschen sich ein System, das nicht durch Rückfragen oder Interaktion veränderbar ist. Das zeigt ein gewisses Misstrauen gegenüber KI-Systemen, besonders wenn diese dialogorientiert arbeiten, wie es z.B. bei Chatbots der Fall ist. NutzerInnen möchten ein Ergebnis, das klar und fest ist, nicht eins, das sich durch ihre Eingabe ändern kann. Dies weist auf ein tiefes Bedürfnis nach Transparenz, Stabilität und Objektivität hin.
Die quantitativen Befunde ergänzen dieses Bild. Die mentale Belastung wurde von den Teilnehmenden im Mittel als moderat empfunden, mit leichten Schwankungen zwischen den KI-Varianten. Allerdings zeigte sich kein signifikanter Unterschied zwischen der evaluativen und der empfehlenden KI. Das bedeutet, dass keine der beiden Formen kognitiv eindeutig entlastender oder fordernder war. Dennoch ergab sich ein signifikanter negativer Zusammenhang zwischen mentaler Belastung und Vertrauen: Wer sich durch die Nutzung stärker belastet fühlte, brachte der KI tendenziell weniger Vertrauen entgegen. Diese Erkenntnis ist besonders relevant, da Vertrauen als zentrale Voraussetzung für die Akzeptanz technischer Systeme gilt.
Aus den Ergebnissen lassen sich verschiedene gesellschaftliche und wissenschaftliche Implikationen ableiten. Gesellschaftlich zeigt die Studie, dass KI-Systeme zur Misinformationerkennung dann auf Akzeptanz stoßen, wenn sie nutzerfreundlich, transparent und unabhängig gestaltet sind. Die NutzerInnen sind bereit, solche Systeme einzusetzen, erwarten aber ein hohes Maß an Klarheit und Verlässlichkeit. Besonders in einer Zeit, in der falsche Informationen immer leichter verbreitet werden können, ist es wichtig, technische Hilfsmittel bereitzustellen, die nicht nur funktionieren, sondern auch ethisch vertretbar und vertrauenswürdig sind. Die Erkenntnisse könnten z.B. in Richtlinien zur Gestaltung von digitalen Informationsplattformen einfließen oder in die Entwicklung von gesetzlichen Rahmenbedingungen für KI-Systeme, die mit gesellschaftlich relevanten Inhalten arbeiten.
Aus wissenschaftlicher Sicht erweitert die Studie den bestehenden Forschungsstand um konkrete NutzerInnenperspektiven. Während viele Arbeiten sich auf technische Leistungsfähigkeit oder rein theoretische Überlegungen konzentrieren, bringt diese Untersuchung empirische Daten aus der Anwendungsperspektive ein. Damit bietet sie eine wichtige Grundlage für weitere Forschung zur Gestaltung und Evaluation von erklärbaren KI-Systemen im Bereich der Desinformationsbekämpfung. Besonders die Differenzierung zwischen empfehlender und evaluierender Rückmeldung ist hier ein interessanter Ansatzpunkt, auch wenn in dieser Studie kein signifikanter Unterschied festgestellt werden konnte.
Natürlich sind auch einige Limitationen zu beachten. Die qualitative Teilstudie umfasst nur zwei Interviews, was die Generalisierung einschränkt. Auch die Stichprobe der quantitativen Umfrage war nicht repräsentativ: Die Teilnehmenden wurden zum Teil im studentischen Umfeld rekrutiert, was zu einer gewissen Vorbildung und Technikaffinität führen könnte. Außerdem wurde ausschließlich mit textbasierten Social-Media-Beiträgen gearbeitet – andere Formate wie Bilder oder Videos, die ebenfalls häufig zur Verbreitung von Falschinformationen genutzt werden, blieben unberücksichtigt. Darüber hinaus könnte der politische und technologische Kontext zur Zeit der Erhebung die Einschätzungen beeinflusst haben.
Zukünftige Studien könnten daher mehrere Richtungen einschlagen. Erstens wäre es sinnvoll, die qualitative Erhebung mit mehr Interviewpartner:innen zu wiederholen, um differenziertere Perspektiven zu erhalten. Zweitens sollten auch andere Medienformate einbezogen werden, um die Generalisierbarkeit der Erkenntnisse zu prüfen. Auch eine Längsschnittstudie, die Veränderungen im Vertrauen und Belastungsempfinden über längere Zeiträume erfasst, könnte spannende Erkenntnisse liefern. Schließlich wäre es interessant, die Integration solcher KI-Systeme in bestehende Plattformen (z. B. als Browser-Add-ons oder App-Features) zu untersuchen, um herauszufinden, wie sie sich im Alltag bewähren.
Zusammenfassend lässt sich sagen, dass diese Studie erste wichtige Einsichten darüber liefert, wie NutzerInnen KI-Anwendungen zur Misinformationserkennung bewerten. Sie zeigt, dass technische Funktionalität allein nicht ausreicht – vielmehr müssen Aspekte wie Vertrauen, Transparenz und Nutzerfreundlichkeit mitgedacht werden. Damit leistet die Arbeit einen Beitrag zur gesellschaftlich verantwortungsvollen Gestaltung von KI-Systemen.
