...
Die vorliegende Studie verfolgte das Ziel, Anforderungen von Nutzerenden an eine KI-Anwendung zur Erkennung von Misinformationen auf Social Media zu identifizieren. Zu diesem Zweck wurde ein Mixed-Method-Ansatz gewählt, bestehend aus zwei qualitativen Interviews und einer quantitativen Online-Umfrage mit 176 Teilnehmenden. Diese Kombination erlaubte es, sowohl subjektive Einschätzungen und Wünsche als auch objektive Messdaten wie mentale Belastung und Vertrauen zu erheben. Besonders im Vordergrund stand dabei die Frage, wie die Nutzenden die Gestaltung, Funktion und Wirkung einer solchen Anwendung erleben und welche Aspekte für sie besonders wichtig sind. Die qualitativen Ergebnisse machen deutlich, dass Nutzende hohe Erwartungen an die Gestaltung von KI-Systemen haben. Genannt wurden unter anderem Barrierefreiheit, einfache und schnelle Verständlichkeit, nachvollziehbare Quellenangaben, politische Neutralität sowie Unabhängigkeit von personenbezogenen Daten. Interessant war auch die Betonung der Beständigkeit der KI-Ergebnisse – es wird sich ein System gewünscht, dessen Detektionsergebnisse nicht durch Rückfragen oder Interaktion veränderbar sind. Das zeigt ein gewisses Misstrauen gegenüber KI-Systemen, besonders wenn diese dialogorientiert arbeiten, wie es beispielsweise bei Chatbots der Fall ist. Nutzende möchten robustes Ergebnis, das nachvollziehbar und selbstständig mittels der Quellen hinterfragbar ist. Dies weist auf ein bestehendes Bedürfnis nach Transparenz, Stabilität und Objektivität hin. Die quantitativen Befunde ergänzen dieses Bild. Die mentale Belastung wurde von den Teilnehmenden im Mittel als moderat empfunden, mit leichten Schwankungen zwischen den KI-Varianten. Allerdings zeigte sich kein signifikanter Unterschied zwischen der evaluativen und der empfehlenden KI. Das bedeutet, dass keine der beiden Formen kognitiv eindeutig entlastender oder fordernder war. Ebenso konnte zwischen der empfundenen mentalen Belastung und dem Vertrauen in das System kein signifikanter Zusammenhang festgestellt werden, wenngleich eine geringsfügige Tendenz vorlag, dass hohe mentale Belastung das Vertrauen in das KI-System senken könnte. Um in diesem Aspekt größere Klarheit zu gewinnen, wären zukünftige Studien mit einem größeren Stichprobenumfang denkbar.

Aus den Ergebnissen lassen sich gesellschaftliche und wissenschaftliche Implikationen ableiten. Gesellschaftlich zeigt die Studie, dass KI-Systeme zur Misinformationerkennung dann auf Akzeptanz stoßen, wenn sie nutzerfreundlich, transparent und unabhängig gestaltet sind. Die Nutzenden sind bereit, solche Systeme einzusetzen, erwarten aber ein hohes Maß an Klarheit und Verlässlichkeit. Besonders in einer Zeit, in der falsche Informationen immer leichter verbreitet werden können, ist es wichtig, technische Hilfsmittel bereitzustellen, die nicht nur funktionieren, sondern auch ethisch vertretbar und vertrauenswürdig sind. Die Erkenntnisse könnten z. B. in die Entwicklung von gesetzlichen Rahmenbedingungen für KI-Systeme, die mit gesellschaftlich relevanten Inhalten arbeiten. Aus wissenschaftlicher Sicht erweitert die Studie den bestehenden Forschungsstand um konkrete Nutzendenperspektiven. Während viele Arbeiten sich auf technische Leistungsfähigkeit oder vorwiegend theoretische Überlegungen konzentrieren, bringt diese Untersuchung empirische Daten aus der Anwendungsperspektive ein. Damit bietet sie eine wichtige Grundlage für weitere Forschung zur Gestaltung und Evaluation von KI-Systemen im Bereich der Desinformationsbekämpfung. Besonders die Differenzierung zwischen empfehlender und evaluierender Rückmeldung ist hier ein interessanter Ansatzpunkt, auch wenn in dieser Studie kein signifikanter Unterschied festgestellt werden konnte.

Gleichzeitig sind Limitationen unserer Ergebnisse zu beachten. Die qualitative Teilstudie umfasst nur zwei Interviews, was die Generalisierung einschränkt. Auch die Stichprobe der quantitativen Umfrage war nicht repräsentativ: Die Teilnehmenden wurden zum Großteil im studentischen Umfeld rekrutiert, entsprechend ist die Stichprobe nicht repräsentativ für die allgemeine Population in Deutschland. Außerdem wurde ausschließlich mit textbasierten Social-Media-Beiträgen gearbeitet – andere Formate wie Bilder oder Videos, die ebenfalls häufig zur Verbreitung von Falschinformationen genutzt werden, blieben unberücksichtigt. Darüber hinaus könnte der politische und technologische Kontext zur Zeit der Erhebung die Einschätzungen beeinflusst haben.

Zukünftige Studien könnten daher mehrere Richtungen einschlagen. Erstens wäre es sinnvoll, die qualitative Erhebung mit einer größeren Stichprobe zu wiederholen, um differenziertere Perspektiven zu erhalten. Zweitens sollten auch andere Medienformate einbezogen werden, um die Generalisierbarkeit der Erkenntnisse zu prüfen. Auch eine Längsschnittstudie, die Veränderungen im Vertrauen und Belastungsempfinden über längere Zeiträume erfasst, könnte wichtige Erkenntnisse liefern. Schließlich wäre es interessant, die Integration solcher KI-Systeme in bestehende Plattformen (z. B. als Browser-Add-ons oder App-Features) zu untersuchen, um herauszufinden, wie sie in einem alltäglichen Benutzungskontext wahrgenommen werden. Zusammenfassend liefert diese Studie wichtige Einsichten darüber liefert, wie Nutzende KI-Anwendungen zur Misinformationserkennung bewerten. Sie zeigt, dass technische Funktionalität allein nicht ausreicht – vielmehr müssen Aspekte wie Vertrauen, Transparenz und Nutzerfreundlichkeit mitgedacht werden.
