...
Die Datenerhebung bestand aus mehreren strukturierten Abschnitten, wie in @fig-ablauf-studie vollständig dargestellt. Zu Beginn wurde ein Pre-Test-Fragebogen eingesetzt, um demografische Angaben, Bildungsgrad, interaktionsbezogene Technikaffinität, Social Media Nutzung sowie KI-Vorerfahrung zu erfassen. Im Anschluss bewerteten die Teilnehmenden mehrere Social-Media-Posts, zunächst ohne und dann mit KI-Unterstützung. Nach den Anwendungen folgte ein Fragebogen, in dem die Belastung während der Anwendungen abgefragt wurde Zuletzt wurde ein Fragebogen durchgeführt, der sich spezifisch auf die Wahrnehmung und Bewertung der jeweils eingesetzten KI-Variante bezog.
...
Für die quantitative Studie werden mindestens drei vollständige Teilnahmen pro Gruppenmitglied erhoben. Teilnahmeberechtigt sind Personen ab 18 Jahren mit ausreichenden Deutschkenntnissen, die die Umfrage über PC oder Tablet durchführen. Ausgeschlossen sind Studierende der Veranstaltung „Statistische Methoden in der Nutzerforschung“. Die Stichprobe soll möglichst vielfältig im Hinblick auf Alter und Technikaffinität sein, um Unterschiede in der subjektiven Bewertung von Benutzeroberflächen untersuchen zu können. Eine repräsentative Auswahl wird nicht angestrebt, da es sich um eine explorative Studie im Rahmen einer Lehrveranstaltung handelt.
