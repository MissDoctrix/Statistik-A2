...
-   Begrifflichkeiten Anpassen (Social Media/Soziale Medien, Fake News, Desinformtaion, Misinformation, KI/AI)
...
-   Nutzung Social Media Bevölkerung

-   Relevanz von Disinformation (Vorkommen und Auswirkung)

-   Möglichkeit, Disinformtion zu detektieren mittels KI (und Erfolg davon)

-   KI Vorwissen, Umgang damit (Skepsis vs. Vertrauen, Interpretierbarkeit)

Warum ist Forschungsfrage wichtig?

-   da Desinformation wichtiges Thema und es vielversprechende Detektion gibt, muss betrachtet werden, wie Menschen mit KI-Detektion interagieren, d.h. wie das Tool für Menschen nutzbar gemacht werden kann und als solches empfunden wird (Ohne Verständnis und Vertrauen halt auch sinnlos, ne)

-   KI Tools bestehen, aber menschliche Wahrnehmung (Interkation) und Bedürfnisse (Anforderungen) an Gestaltung (konzeptionell und Oberfläche) wenig erforscht (wissenslücke)

-   Wissensbasis für theoretische Vorüberlegungen, um praktische Gestaltung Basis zugeben. Nicht nur für ein spezifisches Tool, sondern Wissenbasis für Verwanndte Projekte und Themenlagen (da KI immer präsenter eh wichtig)

Welches Ziel verfolgt Forschungsfrage?

-   Ziel: Faktoren herausfinden, die eine erfolgreiche Benutzung von KI-Detektion bedingen, um das Tool für Menschen nutzbarer zu machen

    -   erfolgreich in mehreren Dimensionen: Verständnis, wie man Tool nutzen kann (bedienung, aussagekraft, hinterfragen), Transparenz und Vertrauen, möglichst wenig Stress durch KI Tool

-   konkrete Fragestellung/Hypothese hier

-   Zur Beantwortung dieser Frage verwenden wir sowohl quantitative als auch qualitative Methoden, einschließlich Umfragen und Interviews

Vorgehen, um Ziel zu erreichen?

-   Das Paper ist in folgende Hauptabschnitte gegliedert: Einleitung, Literaturübersicht, Methodik, Ergebnisse, Diskussion und Fazit. Die Einleitung führt in das Thema ein und stellt die Relevanz und Zielsetzung dar. Die Literaturübersicht fasst bestehende Studien und Theorien zusammen und identifiziert Forschungslücken. Im Methodikteil...

-   Methodik vrogehen für Leitfadeninterviews und Methodik mixed Design Umfrage, dann Ergebnisse, auswertung Inhalte Interviews und t-Test wie Korrelationsanalyse (ggf. mit Frage?), Schluss Diskussion der Erkenntnisse und Begrenzung, code of Conduct, Literatur und Anhang mit Text für Interviews
...
Anknüpfend an die Literatur liegt unser Fokus auf der Analyse konzeptioneller und gestalterischer Anforderungen, die Nutzende an eine KI-Anwendung stellen. ***(Ggf anpassen, auf konkrete Frage mappen, für runden Boden des Inhalts.)***
...
-   z.B. Ergebnisse legen nahe, dass bestimmte Features Mehrwert für Weiterentwicklung von KI-Tools zur Detektion von Desinformation...
...
-   Zeitpunkt, politisch Desinformation und großer Boom wie Skepsis KI?
